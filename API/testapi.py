...
def forecast():
    ...
    # Convert the input data to a Pandas dataframe
                      ...
                      if(age>=10 and age<=30):
                       ...
                       data = pd.read_csv("C:\\Flutter Projects\\Project With Flask\\API\\age22.csv")
                       data = data["average length cycle"]
 
                      elif(age>30 and age<=40):
                       print("between 30 and 40")
                       data = pd.read_csv("C:\\Flutter Projects\\Project With Flask\\API\\age35.csv")
                       data = data["average length cycle"]
                      elif(age>40):
                       print("between 40 and 50")
                       data = pd.read_csv("C:\\Flutter Projects\\Project With Flask\\API\\age42.csv")
                       data = data["average length cycle"]  
                      else:
                         print("invalid")
